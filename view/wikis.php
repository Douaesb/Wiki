                                        ...
                                        <div class="flex justify-between">
                                            <div class="flex flex-col justify-between text-sm text-gray-600">
                                                ...
                                                <div class="flex items-center text-green-500 gap-2 mt-3">
                                                    ...
                                                    <span class="ml-1 leading-none"> <?php echo htmlspecialchars(date('j M H:i', strtotime($wiki->getCreationDate()))); ?>
                                                    </span>
                                            ...
                                            <div class="flex items-center gap-6">
                                                <a href="#" title="Edit" class="editButton" data-wiki-id="<?php echo htmlspecialchars($wiki->getwikiID()); ?>" data-wiki-title="<?php echo htmlspecialchars($wiki->getwiki()); ?>" data-wiki-description="<?php echo htmlspecialchars($wiki->getContent()); ?>" data-wiki-category="<?php echo $category->getCategorieID(); ?>" data-wiki-tags="<?php echo htmlspecialchars(json_encode($tags->getTag())); ?>" data-tag-id="<?php echo htmlspecialchars(json_encode($tags->getTagID())); ?>" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                                                ...
                                                <a title="delete" href="wikis.php?deletewiki&wikiID=<?php echo htmlspecialchars($wiki->getwikiID()); ?>">
                                                ...
                                                <a href="detailswiki.php?source=wikis&detailswiki&wikiID=<?php echo htmlspecialchars($wiki->getwikiID()); ?>" title="view details">
