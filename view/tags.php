                    ...
                    <form class="p-4 md:p-5" action="" method="post">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input type="text" name="nompro" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100 border-gray-500 placeholder-gray-400 text-black focus:ring-primary-500 focus:border-primary-500" placeholder="Type Tag title" required="">
                            </div>
                        </div>
                ...
                <div class="relative bg-white rounded-lg shadow bg-blue-50">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="" method="post">
                            <div class="col-span-2">
                                <input type="hidden" name="idpro" id="editTagId">
                                <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-black">Tag title</label>
