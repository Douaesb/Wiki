                    ...
                    <form class="p-4 md:p-5" action="" method="post">
                        <div class="grid gap-4 mb-4 grid-cols-2">
                            <div class="col-span-2">
                                ...
                                <input type="text" name="nompro" id="" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 bg-gray-100 border-gray-500 placeholder-gray-400 text-black focus:ring-primary-500 focus:border-primary-500" placeholder="Type categorie title" required="">
                            </div>
                            <div class="col-span-2">
                                <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-black">categorie date</label>
                            </div>
                ...
                <div class="relative bg-white rounded-lg shadow bg-blue-50">
                    ...
                    <div class="p-4 md:p-5">
                        <form class="space-y-4" action="" method="post">
                            <div class="col-span-2">
                                <input type="hidden" name="idpro" id="editcategorieId">
                                <label for="" class="block mb-2 text-sm font-medium text-gray-900 text-black">categorie title</label>
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="bg-blue-200 rounded-3xl p-8 mb-5">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex flex-col items-center justify-around bg-white overflow-hidden shadow sm:rounded-lg h-full w-full p-1">
                                <div class="flex justify-center justify-center w-10">
                                    <span class="mt-1 text-xl leading-9 font-semibold text-black">categorie</span>
                                </div>
                            ...
                            <div class="flex flex-col items-center justify-around bg-white overflow-hidden shadow sm:rounded-lg min-h-[120px] h-full w-full p-1">
                                <div class="flex justify-center justify-center w-10">
                                    <span class="mt-1 text-xl leading-9 font-semibold text-black">categorie </span>
                                </div>
                                <div class="flex items-center gap-6">
