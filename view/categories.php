                            ...
                            <?php foreach ($cats as $c) : ?>
                                <div class="flex flex-col items-center justify-around bg-white overflow-hidden shadow sm:rounded-lg h-[100px] p-1">
                                    ...
                                    <div class="flex justify-center justify-center w-10">
                                        <span class="mt-1 text-xl font-semibold text-black whitespace-nowrap"><?php echo htmlspecialchars($c->getCategorie()) ?></span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-6">
                                        <div class="flex items-center text-green-500 gap-2">
                                            ...
                                            <span class="ml-1 leading-none"> <?php echo htmlspecialchars(date('j M H:i', strtotime($c->getDateCategorie()))); ?>
                                            </span>

                                        </div>
                                        <a href="#" title="Edit" class="editCategorieButton" data-categorie-id="<?php echo htmlspecialchars($c->getCategorieID()); ?>" data-categorie-name="<?php echo $c->getCategorie(); ?>" data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                                        ...
                                        <a title="delete" href="categories.php?deletecat&categorieID=<?php echo htmlspecialchars($c->getCategorieID()); ?>">
